...
def setup_fields_computer(context):
    ...
    remappings = []
    if planner_mode in ('manipulator', 'oriented_pointmass'):
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        arg_show_requests,
        arg_use_cpu,
        arg_show_pipeline_delays,
        arg_show_total_pipeline_delay,
        arg_enable_robot_body_subtraction,
        perception_group,
        realsense_group,
